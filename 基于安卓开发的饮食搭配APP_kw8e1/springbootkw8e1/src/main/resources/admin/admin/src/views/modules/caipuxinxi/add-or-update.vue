<template>
	<div class="addEdit-block" :style='{"padding":"30px 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="菜品名称" prop="caipinmingcheng">
					<el-input v-model="ruleForm.caipinmingcheng" placeholder="菜品名称" clearable  :readonly="ro.caipinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="菜品名称" prop="caipinmingcheng">
					<el-input v-model="ruleForm.caipinmingcheng" placeholder="菜品名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="口味" prop="kouwei">
					<el-input v-model="ruleForm.kouwei" placeholder="口味" clearable  :readonly="ro.kouwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="口味" prop="kouwei">
					<el-input v-model="ruleForm.kouwei" placeholder="口味" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="菜谱分类" prop="caipufenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="适合人群" prop="shiherenqun">
					<el-input v-model="ruleForm.shiherenqun" placeholder="适合人群" clearable  :readonly="ro.shiherenqun"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="适合人群" prop="shiherenqun">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="碳水" prop="tanshui">
					<el-input v-model="ruleForm.tanshui" placeholder="碳水" clearable  :readonly="ro.tanshui"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="碳水" prop="tanshui">
					<el-input v-model="ruleForm.tanshui" placeholder="碳水" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="食材" prop="shicai">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.shicai" label="食材" prop="shicai">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shicai}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="菜品介绍" prop="caipinjieshao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.caipinjieshao" label="菜品介绍" prop="caipinjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.caipinjieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../springbootkw8e1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
