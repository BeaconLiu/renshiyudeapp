	...
	<div class="addEdit-block" :style='{"padding":"30px 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="记录时间" prop="jilushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jilushijian" label="记录时间" prop="jilushijian">
					<el-input v-model="ruleForm.jilushijian" placeholder="记录时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="早餐" prop="zaocan">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="早餐"
					  v-model="ruleForm.zaocan" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.zaocan" label="早餐" prop="zaocan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zaocan}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="午餐" prop="wucan">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="午餐"
					  v-model="ruleForm.wucan" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.wucan" label="午餐" prop="wucan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.wucan}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="晚餐" prop="wancan">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="晚餐"
					  v-model="ruleForm.wancan" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.wancan" label="晚餐" prop="wancan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.wancan}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="加餐" prop="jiacan">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="加餐"
					  v-model="ruleForm.jiacan" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiacan" label="加餐" prop="jiacan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jiacan}}</span>
				</el-form-item>
