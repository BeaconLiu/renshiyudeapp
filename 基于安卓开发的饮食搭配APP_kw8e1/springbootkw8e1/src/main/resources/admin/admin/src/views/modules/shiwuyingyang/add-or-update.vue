	...
	<div class="addEdit-block" :style='{"padding":"30px 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="食物分类" prop="shiwufenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="食物分类" prop="shiwufenlei">
					<el-input v-model="ruleForm.shiwufenlei"
						placeholder="食物分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="成分含量" prop="chengfenhanliang">
					<el-input v-model="ruleForm.chengfenhanliang" placeholder="成分含量" clearable  :readonly="ro.chengfenhanliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="成分含量" prop="chengfenhanliang">
					<el-input v-model="ruleForm.chengfenhanliang" placeholder="成分含量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="热量" prop="reliang">
					<el-input v-model="ruleForm.reliang" placeholder="热量" clearable  :readonly="ro.reliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="热量" prop="reliang">
					<el-input v-model="ruleForm.reliang" placeholder="热量" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="食物简介" prop="shiwujianjie">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.shiwujianjie" label="食物简介" prop="shiwujianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#797979","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shiwujianjie}}</span>
				</el-form-item>
