...
public class YinshijianyiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YinshijianyiEntity yinshijianyi,
		...
		if(tableName.equals("yonghu")) {
			yinshijianyi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R save(@RequestBody YinshijianyiEntity yinshijianyi, HttpServletRequest request){
    	yinshijianyi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YinshijianyiEntity> wrapper = new EntityWrapper<YinshijianyiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yinshijianyiService.selectCount(wrapper);
