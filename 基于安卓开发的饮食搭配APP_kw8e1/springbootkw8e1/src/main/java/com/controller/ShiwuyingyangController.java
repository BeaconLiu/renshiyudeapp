...
public class ShiwuyingyangController {
    ...
    public R save(@RequestBody ShiwuyingyangEntity shiwuyingyang, HttpServletRequest request){
    	shiwuyingyang.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShiwuyingyangEntity> wrapper = new EntityWrapper<ShiwuyingyangEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shiwuyingyangService.selectCount(wrapper);
